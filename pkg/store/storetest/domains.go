...
func RunStoreSuite(t *testing.T, factory Factory) {
	...
	// PolicyDomain removed — R-5: PolicyStore interface deleted.
...
// PolicyDomain removed — R-5 CO1 cutover: PolicyStore interface deleted.
// Ent schema retained per brief constraint (schema migration out of scope).
