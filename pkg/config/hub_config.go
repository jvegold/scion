...
// IsHubIDAutoGenerated returns true when hub_id was not explicitly configured
// and will be derived from the hostname.
func (c *HubServerConfig) IsHubIDAutoGenerated() bool {
	return c.HubID == ""
}
