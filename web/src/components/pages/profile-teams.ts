...
/**
 * Profile Microsoft Teams linking page
 *
...
@customElement('scion-page-profile-teams')
export class ScionPageProfileTeams extends LitElement {
  @state()
  private _code = '';
    ...
    return html`
      <div class="settings-card">
        ...
        <div class="instructions">
          <ol>
            <li>Open a direct message with the Scion bot in Microsoft Teams</li>
...
declare global {
  interface HTMLElementTagNameMap {
    'scion-page-profile-teams': ScionPageProfileTeams;
  }
}
